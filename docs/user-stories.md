...
**Design system (phone / mockups):** [docs/design-system/00-design-system-index.md](design-system/00-design-system-index.md)
...
| Date | Change |
|------|--------|
| 2026-04-07 | Initial document: merged UX research branch into `dev`, reconciled with MVP decisions (host UI, Media3 transport, no custom Auto chrome). |
